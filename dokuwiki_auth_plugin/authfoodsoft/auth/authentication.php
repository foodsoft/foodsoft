<?php
/**
 * DokuWiki Plugin authfoodsoft (Auth Component)
 *
...
class auth_plugin_authfoodsoft_authentication extends DokuWiki_Auth_Plugin {
    ...
    public function trustExternal($user, $pass, $sticky = false) {
        global $USERINFO, $angemeldet, $login_gruppen_name, $login_gruppen_id;
        global $from_dokuwiki;
        global $conf;
        ...
        if( isset( $_COOKIE['foodsoftkeks'] ) && ( strlen( $_COOKIE['foodsoftkeks'] ) > 1 ) ) {
          ...
          if( $angemeldet ) {
            ...
            if ( $login_gruppen_id == 1 ) {
              $USERINFO['grps'][1] = 'admin';
            }
