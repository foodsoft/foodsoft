...
chmod 664 code/views.php
chmod 664 code/zuordnen.php
...
chmod 664 dokuwiki_auth_plugin/authfoodsoft/auth/authentication.php
...
chmod 664 templates/bestellschein.tex
...
chmod 664 windows/bestellfax.php
chmod 664 windows/bestellschein.php
