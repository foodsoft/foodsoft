...
chmod 600 ./leitvariable.php
chmod 600 ./structure.php
...
chmod 600 ./code/zuordnen.php
chmod 600 ./code/login.php
chmod 644 ./code/common.php
chmod 600 ./code/katalogsuche.php
chmod 600 ./code/views.php
chmod 600 ./code/forms.php
...
chmod 600 ./windows/artikelsuche.php
...
chmod 600 ./windows/updownload.php
...
chmod 600 ./windows/produktpreise.php
...
chmod 600 ./windows/editLieferant.php
chmod 600 ./windows/katalog_upload.php
