						   ...
						   <tr>
						      ...
						      <td>
									   <select name="gruppen_id">
										    <option value="">[auswählen]</option>
										    <?PHP
                           $result = mysql_query("SELECT bestellgruppen.id, bestellgruppen.name FROM bestellgruppen, gruppenbestellungen WHERE gruppenbestellungen.gesamtbestellung_id = ".mysql_escape_string($bestell_id)." AND gruppenbestellungen.bestellguppen_id = bestellgruppen.id ORDER  BY  bestellgruppen.name  ASC ") or error(__LINE__,__FILE__,"Konnte Bestellgruppendaten nich aus DB laden..",mysql_error());
				...
				<table>
				   <tr>
					    <th colspan="7"><h3><?PHP
							...
							echo "Gruppenbestellung - ".$bestellgruppen_row['name']; 
						} else {
