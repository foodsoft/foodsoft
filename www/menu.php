   ...
   <table class="menu">
	   ...
	   <tr>
		    <td><input type="button" value="Bestellungen einsehen" class="bigbutton" onClick="self.location.href='index.php?area=bestellt'"></td>
				<td valign="middle" class="smalfont">Hier können die Ergebnisse der abgeschlossenen Bestellungen eigesehen werden...</td>
		 </tr>		 		 
			<tr>
