...
if( $meinkonto ) {
  ...
  if( ! $readonly ) {
    ...
    <span class='button'
      ...
      title="Hier könnt Ihr freiwillige Spenden zum Abbau der Schulden der Foodcoop eintragen"
  ...
  option_menu_row(
    " <td>Gruppe:</td>
      ...
      . self_url( 'gruppen_id' ) . "');\">
    " . optionen_gruppen( false, false, $gruppen_id, ( $gruppen_id ? false : "(bitte Gruppe wählen)") ) . "
      </select></td>"
  );
  if( ! $gruppen_id )
    return;
  ...
  if( ! $readonly ) {
    ...
    ?>
      ...
      <fieldset class='small_form' id='transactions_menu' style='display:none;margin-bottom:2em;'>
        ...
        <li style='padding-left:1em;' title='überweisung auf ein anderes Gruppenkonto'>
        <input type='radio' name='transaktionsart'
        ...
        <li style='padding-left:1em;' title='überweisung von Gruppe an Lieferant'>
        <input type='radio' name='transaktionsart'
          onclick="document.getElementById('einzahlung_form').style.display='none';
                   document.getElementById('gruppegruppe_form').style.display='none';
                   document.getElementById('gruppesonderausgabe_form').style.display='none';
